              ...
              <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    ...
                    <div v-if="newUser">
                          <h2  class="text-gray-900 text-lg font-medium title-font mb-5">Sign Up</h2>
                              <a class="text-gray-500 mb-3" href="#" @click="newUser = false">Returning User?</a>
                    </div>
                              <div v-else>

                                <h2  class="text-gray-900 text-lg font-medium title-font mb-5">Sign In</h2>
                                    <a class="text-gray-500 mb-3" href="#" @click="newUser = true">New user?</a>
                          </div>
                ...
                <button class="text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg" @click="auth.signInAnonymously()">Login Anonymously</button>
